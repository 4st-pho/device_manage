...
class ManageTeamDevicePage extends StatefulWidget {
  const ManageTeamDevicePage({Key? key}) : super(key: key);

  @override
  State<ManageTeamDevicePage> createState() => _ManageTeamDevicePageState();
}

class _ManageTeamDevicePageState extends State<ManageTeamDevicePage> {
  late final ManageTeamDeviceBloc _manageTeamDeviceBloc;
  @override
  void initState() {
    _manageTeamDeviceBloc = context.read<ManageTeamDeviceBloc>();
    _manageTeamDeviceBloc.updateListDeviceData();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Device>>(
      stream: _manageTeamDeviceBloc.listDeviceStream,
      builder: (_, snapshot) {
